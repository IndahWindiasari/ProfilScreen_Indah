              ...
              children: [
                Row(
                  children: [
                    ...
                    const Spacer(),
                    Text('065120134', style: vkTextCardBold),
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                const Spacer(),
                Text('Indah Windiasari', style: vkTextLightGrey),
              ],
            ),
          ),
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                const Spacer(),
                Text('Indah', style: vkTextLightGrey),
              ],
            ),
          ),
          const Divider(color: Color.fromARGB(255, 86, 16, 126)),
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Kp. Cibarengkok, RT 01/RW 01, Desa Tanjungsari, Kec. Tanjungsari, Kab. Bogor',
